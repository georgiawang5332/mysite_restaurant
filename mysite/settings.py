...
STATICFILES_DIRS = [
    ...
    '/var/www/static/',  # 用不到的時候可以不寫這一行
]

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, "static/dist/media_cdn")
# http://127.0.0.1:5757/media/profile_image/Phone_2.jpg
...
EMAIL_PORT = '587'
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'georgiawang5332@gmail.com'   # 寄件者帳號
EMAIL_HOST_PASSWORD = '0704gta93julro'  # 寄件者password
